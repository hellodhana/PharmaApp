...
//        
//        //draw label
//        UILabel *scoreLabel = [ [UILabel alloc ] initWithFrame:CGRectMake(self.bounds.size.width/2-15, self.bounds.size.height/2-15, 30.0, 30.0) ];
//        scoreLabel.textAlignment =  UITextAlignmentCenter;
//        scoreLabel.textColor = [UIColor whiteColor];
//        scoreLabel.backgroundColor = [UIColor clearColor];
//        scoreLabel.font = [UIFont fontWithName:@"Arial" size:(16.0)];
//        [self addSubview:scoreLabel];
//        scoreLabel.text = [NSString stringWithFormat: @"30"];
//        //
//	} else {
//		// Draw background
